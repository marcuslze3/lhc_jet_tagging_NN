...
batch_size = 16 # change to 64 later (64 causes CUDA to run out of mem)
n_epochs = 5 # originally 1000
patience = 10
...
if True:
    inputTrainFiles = glob.glob("/mnt/ccnas2/bdp/mzl20/proj_conda/lhc_jet_tagging_NN/JEDInet_pytorch/converted/rotation_224_v1/train_file_*.h5")
    inputValFiles = glob.glob("/mnt/ccnas2/bdp/mzl20/proj_conda/lhc_jet_tagging_NN/JEDInet_pytorch/converted/rotation_224_v1/val_file_*.h5")
