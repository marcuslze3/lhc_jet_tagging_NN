...
"""
if True:
	inputFiles = glob.glob("/mnt/ccnas2/bdp/mzl20/proj_conda/lhc_jet_tagging_NN/JEDInet_pytorch/150p_dataset/train/jetImage*_%sp*.h5" %nParticles)
...
inputTestFiles = glob.glob("/mnt/ccnas2/bdp/mzl20/proj_conda/lhc_jet_tagging_NN/JEDInet_pytorch/150p_dataset/val/jetImage*_%sp*.h5" %nParticles)
