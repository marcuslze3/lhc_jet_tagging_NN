...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module selu_float_float_relu2_config_struct_s_selu_table3_rom (
...
initial begin
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table3_rom.dat", ram0);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table3_rom.dat", ram1);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table3_rom.dat", ram2);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table3_rom.dat", ram3);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table3_rom.dat", ram4);
end
...
`timescale 1 ns / 1 ps
module selu_float_float_relu2_config_struct_s_selu_table3(
    reset,
    clk,
    address0,
    ce0,
...
selu_float_float_relu2_config_struct_s_selu_table3_rom selu_float_float_relu2_config_struct_s_selu_table3_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
