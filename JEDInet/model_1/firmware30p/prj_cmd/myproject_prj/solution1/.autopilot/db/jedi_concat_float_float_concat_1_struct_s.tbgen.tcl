set moduleName jedi_concat_float_float_concat_1_struct_s
set isTopModule 0
...
set C_modelName {jedi_concat<float, float, concat_1_struct>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data1 float 32 regular {array 13920 { 1 3 } 1 1 }  }
	{ data2 float 32 regular {array 13920 { 1 3 } 1 1 }  }
	{ res float 32 regular {array 27840 { 0 3 } 0 1 }  }
}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "data1", "role": "address0" }} , 
 	...
 	{ "name": "data2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "data2", "role": "address0" }} , 
 	...
 	{ "name": "res_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "res", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.jedi_mul_mul_5ns_11ns_15_1_1_U1", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "55746", "Max" : "55746"}
	, {"Name" : "Interval", "Min" : "55746", "Max" : "55746"}
]}
...
set Spec2ImplPortList { 
	data1 { ap_memory {  { data1_address0 mem_address 1 14 }  { data1_ce0 mem_ce 1 1 }  { data1_q0 mem_dout 0 32 } } }
	data2 { ap_memory {  { data2_address0 mem_address 1 14 }  { data2_ce0 mem_ce 1 1 }  { data2_q0 mem_dout 0 32 } } }
	res { ap_memory {  { res_address0 mem_address 1 15 }  { res_ce0 mem_ce 1 1 }  { res_we0 mem_we 1 1 }  { res_d0 mem_din 1 32 } } }
}
set moduleName jedi_concat_float_float_concat_1_struct_s
set isTopModule 0
set isTaskLevelControl 1
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "data2", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "res", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.jedi_mul_mul_5ns_11ns_15_1_1_U8", "Parent" : "0"}]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "data2", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "res", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.jedi_mul_mul_5ns_11ns_15_1_1_U13", "Parent" : "0"}]}
