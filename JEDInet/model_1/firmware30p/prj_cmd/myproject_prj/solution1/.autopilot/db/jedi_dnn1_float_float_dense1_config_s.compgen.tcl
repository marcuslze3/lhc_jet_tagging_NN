...
set ID 829
set hasByteEnable 0
set MemName jedi_dnn1_float_float_dense1_config_s_cache1
...
set ID 830
set hasByteEnable 0
set MemName jedi_dnn1_float_float_dense1_config_s_res_assign
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 8
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename E \
    op interface \
    ports { E_address0 { O 13 vector } E_ce0 { O 1 bit } E_we0 { O 1 bit } E_d0 { O 32 vector } } \
} "
} else {
