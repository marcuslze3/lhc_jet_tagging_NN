...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module selu_float_float_relu1_config_struct_s_selu_table1_rom (
...
initial begin
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram0);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram1);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram2);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram3);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram4);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram5);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram6);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram7);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram8);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table1_rom.dat", ram9);
end
...
`timescale 1 ns / 1 ps
module selu_float_float_relu1_config_struct_s_selu_table1(
    reset,
    clk,
    address0,
    ce0,
...
selu_float_float_relu1_config_struct_s_selu_table1_rom selu_float_float_relu1_config_struct_s_selu_table1_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
