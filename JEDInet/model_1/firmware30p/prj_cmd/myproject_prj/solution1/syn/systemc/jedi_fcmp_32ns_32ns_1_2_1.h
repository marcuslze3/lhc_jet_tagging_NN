...
// ==============================================================
#ifndef __jedi_fcmp_32ns_32ns_1_2_1__HH__
#define __jedi_fcmp_32ns_32ns_1_2_1__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(jedi_fcmp_32ns_32ns_1_2_1) {
    ...
    SC_CTOR(jedi_fcmp_32ns_32ns_1_2_1):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
