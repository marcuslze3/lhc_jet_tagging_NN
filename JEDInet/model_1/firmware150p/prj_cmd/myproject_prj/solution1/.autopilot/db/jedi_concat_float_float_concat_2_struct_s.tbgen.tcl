set moduleName jedi_concat_float_float_concat_2_struct_s
set isTopModule 0
...
set C_modelName {jedi_concat<float, float, concat_2_struct>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data1 float 32 regular {array 22500 { 1 3 } 1 1 }  }
	{ data2 float 32 regular {array 1500 { 1 3 } 1 1 }  }
	{ res float 32 regular {array 3900 { 0 3 } 0 1 }  }
}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "data1", "role": "address0" }} , 
 	...
 	{ "name": "data2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "data2", "role": "address0" }} , 
 	...
 	{ "name": "res_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "res", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "jedi_concat_float_float_concat_2_struct_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "7854", "EstimateLatencyMax" : "7854",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7854", "Max" : "7854"}
	, {"Name" : "Interval", "Min" : "7854", "Max" : "7854"}
]}
...
set Spec2ImplPortList { 
	data1 { ap_memory {  { data1_address0 mem_address 1 15 }  { data1_ce0 mem_ce 1 1 }  { data1_q0 mem_dout 0 32 } } }
	data2 { ap_memory {  { data2_address0 mem_address 1 11 }  { data2_ce0 mem_ce 1 1 }  { data2_q0 mem_dout 0 32 } } }
	res { ap_memory {  { res_address0 mem_address 1 12 }  { res_ce0 mem_ce 1 1 }  { res_we0 mem_we 1 1 }  { res_d0 mem_din 1 32 } } }
}
