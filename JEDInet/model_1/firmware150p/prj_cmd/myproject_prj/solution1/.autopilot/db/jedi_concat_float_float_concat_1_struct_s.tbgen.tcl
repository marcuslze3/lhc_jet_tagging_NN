...
set C_modelArgList {
	{ data1 float 32 regular {array 357600 { 1 3 } 1 1 }  }
	{ data2 float 32 regular {array 357600 { 1 3 } 1 1 }  }
	{ res float 32 regular {array 715200 { 0 3 } 1 1 }  }
}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "data1", "role": "address0" }} , 
 	...
 	{ "name": "data2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "data2", "role": "address0" }} , 
 	...
 	{ "name": "res_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "res", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2145666", "EstimateLatencyMax" : "2145666",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.jedi_mul_mul_5ns_16ns_20_1_1_U13", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2145666", "Max" : "2145666"}
	, {"Name" : "Interval", "Min" : "2145666", "Max" : "2145666"}
]}
...
set Spec2ImplPortList { 
	data1 { ap_memory {  { data1_address0 mem_address 1 19 }  { data1_ce0 mem_ce 1 1 }  { data1_q0 mem_dout 0 32 } } }
	data2 { ap_memory {  { data2_address0 mem_address 1 19 }  { data2_ce0 mem_ce 1 1 }  { data2_q0 mem_dout 0 32 } } }
	res { ap_memory {  { res_address0 mem_address 1 20 }  { res_ce0 mem_ce 1 1 }  { res_we0 mem_we 1 1 }  { res_d0 mem_din 1 32 } } }
}
