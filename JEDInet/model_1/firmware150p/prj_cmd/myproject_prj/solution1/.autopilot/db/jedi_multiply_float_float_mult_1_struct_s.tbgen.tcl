set moduleName jedi_multiply_float_float_mult_1_struct_s
set isTopModule 0
...
set C_modelName {jedi_multiply<float, float, mult_1_struct>}
set C_modelType { void 0 }
set C_modelArgList {
	{ data1 float 32 regular {array 22500 { 1 3 } 1 1 }  }
	{ data2 float 32 regular {array 3352500 { 1 3 } 3 1 }  }
	{ res float 32 regular {array 357600 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ res_address0 sc_out sc_lv 19 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "590755233", "EstimateLatencyMax" : "590755233",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "590755233", "Max" : "590755233"}
	, {"Name" : "Interval", "Min" : "590755233", "Max" : "590755233"}
]}
