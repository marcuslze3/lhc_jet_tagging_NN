...
entity p_hls_fptosi_float_i32 is
port (
...
architecture behav of p_hls_fptosi_float_i32 is 
    ...
    signal tmp_V_10_fu_66_p1 : STD_LOGIC_VECTOR (22 downto 0);
    ...
    signal sext_ln1311_10_fu_120_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln1311_15_fu_124_p1 : STD_LOGIC_VECTOR (24 downto 0);
    ...
    signal r_V_10_fu_138_p2 : STD_LOGIC_VECTOR (78 downto 0);
    signal zext_ln662_fu_152_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_23_fu_156_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Val2_39_fu_166_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_s_fu_48_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal result_V_10_fu_174_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_return <= 
        result_V_10_fu_174_p2 when (p_Result_s_fu_48_p3(0) = '1') else 
        p_Val2_39_fu_166_p3;
    isNeg_fu_94_p3 <= add_ln339_fu_88_p2(8 downto 8);
    mantissa_V_fu_70_p4 <= ((ap_const_lv1_1 & tmp_V_10_fu_66_p1) & ap_const_lv1_0);
    p_Result_s_fu_48_p3 <= p_Val2_s_fu_44_p1(31 downto 31);
    p_Val2_39_fu_166_p3 <= 
        zext_ln662_fu_152_p1 when (isNeg_fu_94_p3(0) = '1') else 
        tmp_23_fu_156_p4;
    p_Val2_s_fu_44_p1 <= x;
    r_V_10_fu_138_p2 <= std_logic_vector(shift_left(unsigned(zext_ln682_fu_80_p1),to_integer(unsigned('0' & zext_ln1287_fu_128_p1(31-1 downto 0)))));
    r_V_fu_132_p2 <= std_logic_vector(shift_right(unsigned(mantissa_V_fu_70_p4),to_integer(unsigned('0' & sext_ln1311_15_fu_124_p1(25-1 downto 0)))));
    result_V_10_fu_174_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(p_Val2_39_fu_166_p3));
        sext_ln1311_10_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ush_fu_112_p3),32));

        sext_ln1311_15_fu_124_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(ush_fu_112_p3),25));
    ...
    tmp_23_fu_156_p4 <= r_V_10_fu_138_p2(55 downto 24);
    tmp_V_10_fu_66_p1 <= p_Val2_s_fu_44_p1(23 - 1 downto 0);
    ...
    ush_fu_112_p3 <= 
        ...
        add_ln339_fu_88_p2;
    zext_ln1287_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln1311_10_fu_120_p1),79));
