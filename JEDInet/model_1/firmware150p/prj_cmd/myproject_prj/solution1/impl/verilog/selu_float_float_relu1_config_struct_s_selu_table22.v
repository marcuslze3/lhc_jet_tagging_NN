...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module selu_float_float_relu1_config_struct_s_selu_table22_rom (
...
initial begin
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram0);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram1);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram2);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram3);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram4);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram5);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram6);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram7);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram8);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram9);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram10);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram11);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram12);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram13);
    $readmemh("./selu_float_float_relu1_config_struct_s_selu_table22_rom.dat", ram14);
end
...
`timescale 1 ns / 1 ps
module selu_float_float_relu1_config_struct_s_selu_table22(
    reset,
    clk,
    address0,
    ce0,
...
selu_float_float_relu1_config_struct_s_selu_table22_rom selu_float_float_relu1_config_struct_s_selu_table22_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
