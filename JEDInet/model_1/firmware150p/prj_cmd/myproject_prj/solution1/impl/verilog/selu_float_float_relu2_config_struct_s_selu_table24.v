...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module selu_float_float_relu2_config_struct_s_selu_table24_rom (
...
initial begin
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram0);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram1);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram2);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram3);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram4);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram5);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram6);
    $readmemh("./selu_float_float_relu2_config_struct_s_selu_table24_rom.dat", ram7);
end
...
`timescale 1 ns / 1 ps
module selu_float_float_relu2_config_struct_s_selu_table24(
    reset,
    clk,
    address0,
    ce0,
...
selu_float_float_relu2_config_struct_s_selu_table24_rom selu_float_float_relu2_config_struct_s_selu_table24_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
