...
entity jedi_B_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 20; 
            MEM_SIZE    : integer := 715200
    ); 
    port (
...
architecture rtl of jedi_B_ram is 
...
architecture arch of jedi_B is
    component jedi_B_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    jedi_B_ram_U :  component jedi_B_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
