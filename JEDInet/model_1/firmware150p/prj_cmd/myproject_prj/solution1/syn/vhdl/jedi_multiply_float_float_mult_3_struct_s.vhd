...
entity jedi_multiply_float_float_mult_3_struct_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of jedi_multiply_float_float_mult_3_struct_s is 
    ...
    signal add_ln50_fu_184_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln50_reg_281 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal add_ln50_1_fu_190_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal add_ln50_1_reg_286 : STD_LOGIC_VECTOR (17 downto 0);
    signal i_fu_202_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_reg_294 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_fu_214_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal res_addr_reg_312 : STD_LOGIC_VECTOR (10 downto 0);
    signal k_fu_245_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal k_reg_320 : STD_LOGIC_VECTOR (14 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal add_ln61_fu_255_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal add_ln61_reg_325 : STD_LOGIC_VECTOR (17 downto 0);
    signal icmp_ln59_fu_239_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln61_2_fu_261_p2 : STD_LOGIC_VECTOR (21 downto 0);
    signal add_ln61_2_reg_330 : STD_LOGIC_VECTOR (21 downto 0);
    ...
    signal i_0_reg_94 : STD_LOGIC_VECTOR (3 downto 0);
    signal phi_mul1_reg_105 : STD_LOGIC_VECTOR (17 downto 0);
    signal phi_mul3_reg_117 : STD_LOGIC_VECTOR (10 downto 0);
    signal j_0_reg_129 : STD_LOGIC_VECTOR (7 downto 0);
    signal icmp_ln50_fu_196_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal storemerge_reg_140 : STD_LOGIC_VECTOR (31 downto 0);
    signal k_0_reg_153 : STD_LOGIC_VECTOR (14 downto 0);
    signal phi_mul_reg_164 : STD_LOGIC_VECTOR (21 downto 0);
    signal zext_ln57_2_fu_234_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln61_2_fu_272_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln61_1_fu_277_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal zext_ln57_1_fu_224_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal add_ln57_fu_228_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal zext_ln61_fu_251_p1 : STD_LOGIC_VECTOR (17 downto 0);
    signal add_ln61_1_fu_267_p2 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
    jedi_fadd_32ns_32ns_32_4_full_dsp_1_U1592 : component jedi_fadd_32ns_32ns_32_4_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    jedi_fmul_32ns_32ns_32_3_max_dsp_1_U1593 : component jedi_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln56_fu_208_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                phi_mul1_reg_105 <= add_ln50_1_reg_286;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
                phi_mul_reg_164 <= add_ln61_2_reg_330;
            elsif (((icmp_ln56_fu_208_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                add_ln50_1_reg_286 <= add_ln50_1_fu_190_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln59_fu_239_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                add_ln61_2_reg_330 <= add_ln61_2_fu_261_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln56_fu_208_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                res_addr_reg_312 <= zext_ln57_2_fu_234_p1(11 - 1 downto 0);
                    zext_ln57_reg_307(7 downto 0) <= zext_ln57_fu_220_p1(7 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln57_reg_307(21 downto 8) <= "00000000000000";
    ...
    add_ln50_1_fu_190_p2 <= std_logic_vector(unsigned(phi_mul1_reg_105) + unsigned(ap_const_lv18_574E));
    add_ln50_fu_184_p2 <= std_logic_vector(unsigned(phi_mul3_reg_117) + unsigned(ap_const_lv11_96));
    add_ln57_fu_228_p2 <= std_logic_vector(unsigned(phi_mul3_reg_117) + unsigned(zext_ln57_1_fu_224_p1));
    add_ln61_1_fu_267_p2 <= std_logic_vector(unsigned(phi_mul_reg_164) + unsigned(zext_ln57_reg_307));
    add_ln61_2_fu_261_p2 <= std_logic_vector(unsigned(phi_mul_reg_164) + unsigned(ap_const_lv22_96));
    ...
    data1_address0 <= zext_ln61_1_fu_277_p1(18 - 1 downto 0);
    ...
    data2_address0 <= zext_ln61_2_fu_272_p1(22 - 1 downto 0);
    ...
    i_fu_202_p2 <= std_logic_vector(unsigned(i_0_reg_94) + unsigned(ap_const_lv4_1));
    icmp_ln50_fu_196_p2 <= "1" when (i_0_reg_94 = ap_const_lv4_A) else "0";
    icmp_ln56_fu_208_p2 <= "1" when (j_0_reg_129 = ap_const_lv8_96) else "0";
    icmp_ln59_fu_239_p2 <= "1" when (k_0_reg_153 = ap_const_lv15_574E) else "0";
    j_fu_214_p2 <= std_logic_vector(unsigned(j_0_reg_129) + unsigned(ap_const_lv8_1));
    k_fu_245_p2 <= std_logic_vector(unsigned(k_0_reg_153) + unsigned(ap_const_lv15_1));
    ...
    zext_ln57_1_fu_224_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_129),11));
    zext_ln57_2_fu_234_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln57_fu_228_p2),64));
    zext_ln57_fu_220_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_129),22));
    zext_ln61_1_fu_277_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln61_reg_325),64));
    zext_ln61_2_fu_272_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln61_1_fu_267_p2),64));
    zext_ln61_fu_251_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(k_0_reg_153),18));
end behav;
