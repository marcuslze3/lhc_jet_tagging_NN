...
struct config2 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 771;
    static const unsigned n_nonzeros = 253;
...
struct config5 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 3161;
    static const unsigned n_nonzeros = 935;
    static const bool store_weights_in_bram = false;
    typedef ap_fixed<16,6> accum_t;
...
struct config8 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 3193;
    static const unsigned n_nonzeros = 903;
    static const bool store_weights_in_bram = false;
    typedef ap_fixed<16,6> accum_t;
